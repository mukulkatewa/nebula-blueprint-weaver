  ...
  return (
    <section id="about-us" className="py-24 bg-background/50">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl md:text-5xl font-bold text-center mb-4 bg-gradient-to-r from-purple-400 via-green-400 to-purple-300 bg-clip-text text-transparent">
          What We Do
        </h2>
        <p className="text-xl text-center text-purple-300 mb-16 max-w-3xl mx-auto">
          We bridge the gap between your business goals and the power of artificial intelligence.
        </p>
        <div className="grid md:grid-cols-3 gap-12">
          {features.map((feature, index) => (
            <div key={index} className="flex flex-col items-center text-center p-8 border border-purple-400/20 rounded-2xl bg-slate-900/50 hover:border-green-400/50 hover:bg-slate-900 transition-all duration-300 transform hover:-translate-y-2">
              <div className="mb-6 p-4 bg-green-900/20 rounded-full">
                {feature.icon}
              </div>
