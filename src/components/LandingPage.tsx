    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0">
        {[...Array(50)].map((_, i) => (
          ...
          >
            <Star className="w-1 h-1 text-green-200 fill-current" />
          </div>
        ))}
      </div>
      ...
      <div className="absolute inset-0 bg-gradient-radial from-green-800/20 via-transparent to-transparent animate-pulse" style={{ animationDelay: '1s' }} />

      {/* Main content */}
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
        <div className="max-w-4xl mx-auto">
          {/* Logo/Title */}
          <h1 className="text-6xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-green-400 via-purple-400 to-green-300 bg-clip-text text-transparent animate-fade-in">
            Aetherius Labs
          </h1>

          {/* Tagline */}
          <p className="text-xl md:text-2xl text-green-100 mb-12 animate-fade-in" style={{ animationDelay: '0.5s' }}>
          ...
          <Button
            ...
            className="group relative px-12 py-6 text-xl font-semibold bg-gradient-to-r from-green-600 to-purple-600 hover:from-green-500 hover:to-purple-500 text-white border-2 border-purple-400/50 rounded-full transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/25 animate-fade-in"
          ...
          <div className="absolute top-20 left-10 animate-bounce" style={{ animationDelay: '2s', animationDuration: '3s' }}>
            <div className="w-4 h-4 bg-gradient-to-r from-green-400 to-green-500 rounded-full blur-sm" />
          </div>
