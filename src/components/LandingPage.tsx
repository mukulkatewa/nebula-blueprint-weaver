      ...
      <main>
        ...
        <section className="relative flex flex-col items-center justify-center min-h-screen px-4 text-center pt-20 overflow-hidden">
          ...
          <div className="absolute inset-0 z-0 opacity-30">
            <div className="absolute -top-1/4 -left-1/4 w-1/2 h-1/2 rounded-full bg-gradient-radial from-purple-600 to-transparent blur-3xl animate-pulse"></div>
            <div className="absolute -bottom-1/4 -right-1/4 w-1/2 h-1/2 rounded-full bg-gradient-radial from-green-600 to-transparent blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
          </div>
